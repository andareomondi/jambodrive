      ...
      <DialogContent className="sm:max-w-[500px] rounded-3xl">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-9 rounded-xl bg-slate-50 border-none h-11"
              />
            </div>
          </div>
        </form>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={isLoading}
            className="bg-accent hover:bg-accent/90 text-white rounded-xl h-12 flex-[2] font-bold shadow-lg shadow-accent/20"
          >
            {isLoading ? (
