...
export function DashboardClientWrapper({
  ...
  // Hydrate local state with server-side fetched data
  ...
  // Deriving active vs past rentals from state
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 space-y-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <Button
            ...
            className="bg-accent hover:bg-accent/90 text-white shadow-sm rounded-full px-6 transition-transform active:scale-95"
          >
